...
def byte(addr):
    ...
    """
    return readtype(pwngef.typeinfo.uchar, addr)
...
def ushort(addr):
    ...
    """
    return readtype(pwngef.typeinfo.ushort, addr)
...
def uint(addr):
    ...
    """
    return readtype(pwngef.typeinfo.uint, addr)
...
def pvoid(addr):
    ...
    """
    return readtype(pwngef.typeinfo.pvoid, addr)
...
def u8(addr):
    ...
    """
    return readtype(pwngef.typeinfo.uint8, addr)
...
def u16(addr):
    ...
    """
    return readtype(pwngef.typeinfo.uint16, addr)
...
def u32(addr):
    ...
    """
    return readtype(pwngef.typeinfo.uint32, addr)
...
def u64(addr):
    ...
    """
    return readtype(pwngef.typeinfo.uint64, addr)
...
def s8(addr):
    ...
    """
    return readtype(pwngef.typeinfo.int8, addr)
...
def s16(addr):
    ...
    """
    return readtype(pwngef.typeinfo.int16, addr)
...
def s32(addr):
    ...
    """
    return readtype(pwngef.typeinfo.int32, addr)
...
def s64(addr):
    ...
    """
    return readtype(pwngef.typeinfo.int64, addr)
...
def find_upper_boundary(addr, max_pages=1024):
    ...
    page is found.
    """
    addr = pwngef.memory.page_align(int(addr))
    try:
        for i in range(max_pages):
            pwngef.memory.read(addr, 1)
            # import sys
            # sys.stdout.write(hex(addr) + '\n')
            addr += pwngef.memory.PAGE_SIZE
            if addr > pwngef.arch.ptrmask:
                break
...
class Page(object):
    ...
    def __str__(self):
        width = 2 + 2 * pwngef.typeinfo.ptrsize
